 ...
 * Note that this is the MPI + dynamic scheduling
 */
...
void draw(Display * display, Window win, GC gc, int row, int * colors)
{
    ...
    for(j=0; j < X_RESN; j++) {
        // draw colorful
        XSetForeground (display, gc, colors[j] * 10000);
...
int main(int argc, char **argv) {
    ...
    if (rank != 0) {
        ...
        /* task dynamic arrangement and displaying */
        ...
        /* task dynamic arrangement and displaying ends */
